...
import 'package:handyph_app/features/chat/data/mock_chat_data.dart';

/// Chat — Chat with Worker Screen
///
/// Real-time messaging UI with:
///   - App bar: worker avatar, name, online status
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  final List<Map<String, dynamic>> _messages =
      List.from(MockChatData.messages);
  ...
  Widget build(BuildContext context) {
    final worker = MockChatData.worker;
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        (worker['isOnline'] as bool) ? 'Online' : 'Offline',
